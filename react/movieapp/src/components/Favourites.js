              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col"><i class="fa-solid fa-sort-down"onClick={this.sortPopularityAesc}></i>Popularity<i class="fa-solid fa-sort-up"onClick={this.sortPopularityDesc}></i></th>
                    <th scope="col"><i class="fa-solid fa-sort-down"onClick={this.sortRatingAesc}></i>Ratings<i class="fa-solid fa-sort-up"onClick={this.sortRatingDesc}></i></th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
